...
namespace Xam.Plugin.WebView.Abstractions
{
    public partial class FormsWebView
    {
        ...
        public static readonly BindableProperty NavigatingProperty =
            BindableProperty.Create(nameof(Navigating), typeof(bool), typeof(FormsWebView), false);

        /// <summary>
        ///     A bindable property for the Source property.
        /// </summary>
        public static readonly BindableProperty SourceProperty =
            BindableProperty.Create(nameof(Source), typeof(string), typeof(FormsWebView));
        ...
        public static readonly BindableProperty EnableGlobalCallbacksProperty =
            BindableProperty.Create(nameof(EnableGlobalCallbacks), typeof(bool), typeof(FormsWebView), true);
        ...
        public static readonly BindableProperty EnableGlobalHeadersProperty =
            BindableProperty.Create(nameof(EnableGlobalHeaders), typeof(bool), typeof(FormsWebView), true);
        ...
        public static readonly BindableProperty UseWideViewPortProperty =
            BindableProperty.Create(nameof(UseWideViewPort), typeof(bool), typeof(FormsWebView), false);
        ...
        internal static readonly Dictionary<string, Action<string>> GlobalRegisteredCallbacks =
