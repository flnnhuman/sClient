...
[assembly: InternalsVisibleTo("sc.Android")]
...
namespace Xam.Plugin.WebView.Abstractions
{
    public partial class FormsWebView : View, IFormsWebView, IDisposable
    {
        ...
        internal readonly Dictionary<string, Action<string>> LocalRegisteredCallbacks =
            new Dictionary<string, Action<string>>();

        /// <summary>
        ///     A dictionary containing all headers to be injected into the request. Local headers take precedence over global
        ///     ones.
        /// </summary>
        ...
        /// <summary>
        ///     Fires when the content on the DOM is ready. All your calls to Javascript using C# should be performed after this is
        ///     fired.
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        ///     All cookies found for the current website. Returned on regular format "KEY=VALUE; KEY2=VALUE2". If no cookies
        ///     where found, returns string.Empty
        /// </returns>
        ...
        /// <param name="duration">
        ///     Expiration of cookie in seconds. If set to 0 or lower, the cookie is deleted. If not specified
        ///     the cookie is set as sessioncookie and removed on app-close (Only works with iOS/macOS for now)
        /// </param>
        /// <returns>A string with the cookievalue. is string.Empty if there is no cookie with that name</returns>
        ...
        /// <summary>
        ///     Adds a callback to the DOM, this callback when passed a string by the Javascript, will fire an action with that
        ...
        ///     Note: this does not remove it from the DOM, rather it removes the action, resulting in your view never getting the
        ///     response.
        /// </summary>
        ...
        internal DecisionHandlerDelegate HandleNavigationStartRequest(string uri)
        {
            ...
            var validUri = Uri.TryCreate(uri, UriKind.Absolute, out Uri uriResult);
