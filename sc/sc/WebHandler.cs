...
namespace sc
{
    public class WebHandler
    {
            ...
            string parentalCode = null)
        {
            ...
            using (var iSteamUserAuth = Bot.SteamConfiguration.GetAsyncWebAPIInterface(ISteamUserAuth))
            {
                ...
                try
                {
                    response = await WebLimitRequest(
                        ...
                        async () => await iSteamUserAuth.CallAsync(
                            HttpMethod.Post, "AuthenticateUser",
            ...
            byte maxTries = WebBrowser.MaxTries)
        {
            ...
            var response = await WebLimitRequest(serviceURL,
            ...
            if (await IsProfileUri(response.FinalUri, false).ConfigureAwait(false))
            {
                ...
                return await UnlockParentalAccountForService(serviceURL, parentalCode, --maxTries)
                    .ConfigureAwait(false);
            }
